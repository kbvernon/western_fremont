...
ggsave(
  plot = for_print,
  filename = here("figures", "covariates.jpg"),
  width = 5.75,
  height = 5.75 * (dy/dx),
  dpi = 600
)
...
ggsave(
  ...
  filename = here("figures", "threshold_distributions.jpg"),
  width = 5.75,
  height = 5.75 * (dy/(2*dx)),
  dpi = 600
)
...
ggsave(
  ...
  filename = here("figures", "marginal_response.jpg"),
  width = 5,
  height = 5 * 0.93,
  dpi = 600
)
...
ggsave(
  plot = (obs + estimate),
  filename = here("figures", "model-map.jpg"),
  width = 5.75,
  height = 5.75 * (dy/(2*dx)),
  dpi = 600
)
...
ggsave(
  ...
  filename = here("figures", "threshold_map.jpg"),
  width = 5.75,
  height = 5.75 * (dy/(2*dx)),
  dpi = 600
)
